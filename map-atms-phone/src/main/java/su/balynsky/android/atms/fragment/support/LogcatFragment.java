package su.balynsky.android.atms.fragment.support;
...
public class LogcatFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adaptor = new LogStringAdaptor(this.getActivity(), R.id.txtLogString, logarray);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_logcat, container);
    }
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(LogcatFragment.this.getActivity());
    ...
    private class LogStringAdaptor extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (null == view) {
                LayoutInflater vi = (LayoutInflater) LogcatFragment.this
                        .getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                view = vi.inflate(R.layout.logcat_item, parent, false);
            }
