...
import su.balynsky.android.atms.content.helper.PlaceDetailsJSONParser;
import su.balynsky.android.atms.content.helper.PlaceJSONParser;
...
public class PlaceProvider extends ContentProvider {
    private static final String TAG = PlaceProvider.class.getCanonicalName();

    public static final String AUTHORITY = "su.balynsky.android.atms.content.provider.PlaceProvider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Log.d(TAG, "PlaceProvider.doQuery");
        Log.d(TAG, String.format("query uri=%s projection=%s selection=%s selectionArgs=%s",
                uri, Arrays.toString(projection), selection, Arrays.toString(selectionArgs)));
        ...
        switch (mUriMatcher.match(uri)) {
            case SEARCH:
                ...
                try {
                    ...
                    for (HashMap<String, String> hMap : list) {
                        ...
                        for (HashMap<String, String> hMapDetails : detailsList) {
            ...
            case SUGGESTIONS:
                ...
                // Get Places from Google Places API
                jsonString = getPlaces(selectionArgs);
                Log.d(TAG, "getPlaces " + jsonString);
    ...
    private String getPlaceDetailsUrl(String ref) {
        ...
        String parameters = reference + "&" + sensor + "&" + getApiKey();//mKey;
    ...
    private String getPlacesUrl(String qry) {
        ...
        // Building the parameters to the web service
        String parameters = qry + "&" + types + "&" + sensor + "&" + getApiKey();//mKey;
    ...
    private static String getApiKey() {
        return "key=AIzaSyA5KcrGg3-vBR1WRtH4LFdHebjfwBtXZpw";//+Resources.getSystem().getString(R.string.google_api_key);
    }
}